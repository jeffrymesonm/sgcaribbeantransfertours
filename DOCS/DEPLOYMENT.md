...
- [x] Real contact email in all 5 footers — `sg.caribbeantrasferstours@gmail.com`
...
- [x] Real domain (`sgcaribbeantransfertours.com`) in the `<link rel="canonical">` + Open Graph block of all 5 HTML pages (set 2026-07-20)
